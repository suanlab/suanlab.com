...
const translations = {
  ko: {
    ...
    'nav.lecture': '강의 노트',
    'nav.course': '특강/세미나',
    'nav.deadlines': '학회 마감일',
    'nav.prompts': '프롬프트 라이브러리',
    'nav.youtube': '유튜브',
    'nav.qt': 'QT 묵상',
    'nav.search': '검색',
    'nav.contact': '연락처',
    ...
    'pageheader.book.subtitle': '출간 도서 및 온라인 도서',
    'pageheader.lecture.subtitle': '강의 노트 및 교육 자료',
    'pageheader.course.subtitle': '특강 및 세미나 경력',
    'pageheader.deadlines.subtitle': 'AI/ML 주요 학술대회 논문 마감일 및 일정',
    'pageheader.prompts.subtitle': 'AI/ML 연구를 위한 프롬프트 빌더와 큐레이션 라이브러리',
    'pageheader.youtube.subtitle': '영상으로 데이터 사이언스와 AI를 배워보세요',
    'pageheader.qt.subtitle': '매일 묵상과 말씀',
    'pageheader.contact.subtitle': '연락처 및 위치 안내',
  ...
  en: {
    ...
    'pageheader.book.subtitle': 'Published and Online Books',
    'pageheader.lecture.subtitle': 'Lecture Notes and Materials',
    'pageheader.course.subtitle': 'Guest Lectures and Seminars',
    'pageheader.deadlines.subtitle': 'Conference Deadlines and Schedules',
    'pageheader.prompts.subtitle': 'Prompt builders and a curated library for AI/ML research',
    'pageheader.youtube.subtitle': 'Learn Data Science and AI through Videos',
    'pageheader.qt.subtitle': 'Daily Devotionals',
    'pageheader.contact.subtitle': 'Contact and Location',
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = (key: string): string | string[] => {
    ...
    if (key in dict) {
      return dict[key] as string | string[];
    }
    return key;
  };
