...
export const academicActivities: AcademicActivity[] = [
  ...
  { id: 2, period: '2026.06.23-26', organization: '2026 한국컴퓨터종합학술대회 (KCC 2026)', role: '평가위원', category: 'conference' },
  { id: 3, period: '2026.04.27-30', organization: 'DASFAA 2026', role: 'Web Chair', category: 'conference' },
  { id: 4, period: '2026.02.02-05', organization: 'IEEE BigComp 2026', role: 'Demo Chair', category: 'conference' },
  // 2025
  { id: 5, period: '2025.12.16', organization: '데이터소사이어티 워크샵 2025', role: '조직위원장', category: 'workshop' },
  { id: 6, period: '2025.12.12-14', organization: 'KJDB 2025: Korea-Japan Database Workshop 2025', role: 'Session Chair', category: 'workshop' },
  { id: 7, period: '2025.07.02-04', organization: '2025 한국컴퓨터종합학술대회 (KCC 2025)', role: '평가위원', category: 'conference' },
  { id: 8, period: '2025.06.29-07.02', organization: '데이터지능워크샵 2025', role: '조직위원', category: 'workshop' },
  { id: 9, period: '2025.02.09-12', organization: 'IEEE BigComp 2025', role: 'Poster Session Chair', category: 'conference' },
  // 2024
  { id: 11, period: '2024.12.18-20', organization: '2024 한국소프트웨어종합학술대회 (KSC 2024)', role: '평가위원', category: 'conference' },
  { id: 12, period: '2024.12.10-15', organization: 'NeurIPS 2024', role: 'Member', category: 'conference' },
  { id: 13, period: '2024.11.21-22', organization: '2024 인공지능학회 추계학술대회', role: 'Member', category: 'conference' },
  { id: 14, period: '2024.11.15-17', organization: 'KJDB 2024: Korea-Japan Database Workshop 2024', role: 'Web Chair', category: 'workshop' },
  { id: 15, period: '2024.11.01-02', organization: '제26회 Korean Database Conference (KDBC) 2024', role: '공동조직위원장', category: 'conference' },
  { id: 16, period: '2024.09.27-28', organization: '제42회 미래 정보 기술·산업 전망 (iTIP 2024)', role: 'Member', category: 'forum' },
  { id: 17, period: '2024.06', organization: 'Korea Summer Workshop on Causal Inference 2024', role: 'Member', category: 'workshop' },
  { id: 18, period: '2024.02.18-21', organization: 'IEEE BigComp 2024', role: 'Poster Session Chair', category: 'conference' },
  // 2023
  { id: 20, period: '2023.12.20-22', organization: '2023 한국소프트웨어종합학술대회 (KSC 2023)', role: '평가위원', category: 'conference' },
  { id: 21, period: '2023.12.10-16', organization: 'NeurIPS 2023', role: 'Member', category: 'conference' },
  { id: 22, period: '2023.11.03-04', organization: 'KDBC 2023', role: 'PC, 좌장', category: 'conference' },
  { id: 23, period: '2023.11.01', organization: '제4회 충북 K-한방 정밀의료 국제포럼', role: '좌장', category: 'forum' },
  { id: 24, period: '2023.10.27-29', organization: 'KJDB 2023: Korea-Japan Database Workshop 2023', role: 'Member', category: 'workshop' },
  { id: 25, period: '2023.06.19', organization: '2023 한국컴퓨터종합학술대회 (KCC2023)', role: '평가위원', category: 'conference' },
  { id: 26, period: '2023.06.18', organization: 'KCC 2023 데이터베이스 소사이어티 분과 워크샵', role: '프로그램 위원장', category: 'workshop' },
  { id: 27, period: '2023.03.02', organization: '2023 충북 K-한방 정밀의료 국제포럼', role: '좌장', category: 'forum' },
  { id: 28, period: '2023.02.13-16', organization: 'BigComp 2023: IEEE International Conference on Big Data and Smart Computing', role: 'Poster Session Chair', category: 'conference' },
  // 2022
  { id: 30, period: '2022.12.02-03', organization: 'KJDB 2022: Korea-Japan Database Workshop 2022', role: 'Organization Co-chairs', category: 'workshop' },
  { id: 31, period: '2022.07.18-19', organization: '2022년 전자공학회 영상이해/영상처리 연구회', role: 'Member', category: 'workshop' },
  { id: 32, period: '2022.06.30-07.01', organization: 'KCC 2022 한국컴퓨터종합학술대회', role: '평가위원', category: 'conference' },
  { id: 33, period: '2022.01.17', organization: 'VOICE AI 2022 Workshop', role: 'Chair', category: 'workshop' },
  { id: 34, period: '2022.01.17-20', organization: 'BigComp 2022: IEEE International Conference on Big Data and Smart Computing', role: 'PC member, On-line Presentation Co-Chairs', category: 'conference' },
  // 2021
  { id: 36, period: '2021.10.21', organization: '정보통신기획평가원 국제 인공지능 토론회 (Global AI Forum)', role: 'Member', category: 'forum' },
  { id: 37, period: '2021.04.28', organization: '2021 충북 K-한방 정밀의료 국제포럼', role: 'Speaker', category: 'forum' },
  { id: 38, period: '2021.01.17', organization: 'VOICE AI 2021 Workshop', role: 'Chair', category: 'workshop' },
  { id: 39, period: '2021.01.17-20', organization: 'BigComp2021: IEEE International Conference on Big Data and Smart Computing', role: 'PC member, Culture & Activity Co-Chairs', category: 'conference' },
  // 2020
  { id: 41, period: '2020.09.26-27', organization: 'PyCon Korea 2020', role: 'Member', category: 'conference' },
  { id: 42, period: '2020.08.10-12', organization: '서울대학교 AI 여름 학교', role: 'Member', category: 'workshop' },
  { id: 43, period: '2020.04.14-15', organization: '전자공학회 딥러닝 기술과 자율이동체 응용', role: 'Member', category: 'workshop' },
  { id: 44, period: '2020.02.19-22', organization: 'IEEE BigComp 2020', role: 'Culture & Activity Chair, Session Chair', category: 'conference' },
  // 2019
  { id: 46, period: '2019.12.18', organization: '2019 ETRI AI Practice Tech Day', role: 'Member', category: 'conference' },
  { id: 47, period: '2019.12.17', organization: '글로벌 AI 컨퍼런스 AICON 2019', role: 'Member', category: 'conference' },
  { id: 48, period: '2019.12.07', organization: 'MODUCON 2019', role: 'Member', category: 'conference' },
  { id: 49, period: '2019.12.03', organization: 'AI 기반 사회문제해결형 R/D 추진전략 컨퍼런스', role: 'Member', category: 'conference' },
  { id: 50, period: '2019.11.29', organization: '2019 마이데이터 컨퍼런스', role: 'Member', category: 'conference' },
  { id: 51, period: '2019.09.04', organization: 'AI HIDDEN STAR 2019 DEMO DAY & TALK', role: 'Member', category: 'conference' },
  { id: 52, period: '2019.08.28', organization: '해외전문가 튜토리얼 – eXplainable AI', role: 'Member', category: 'workshop' },
  { id: 53, period: '2019.07.25-26', organization: 'THE AI KOREA 2019 컨퍼런스', role: 'Member', category: 'conference' },
];
