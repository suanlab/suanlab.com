...
const books: Book[] = [
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        downloadUrl: 'https://drive.google.com/file/d/1Gl0P3C2-q8ww9q_-EhuRxTgpFJZsyyRH/view?usp=drive_link',
      },
      {
        title: 'Chapter 3. pygame 배우기',
        items: ['pygame 소개 및 특징', 'pygame 라이브러리 설치', 'pygame 모듈', 'pygame 기본'],
        downloadUrl: 'https://drive.google.com/file/d/1d4IPH7Awq76CyLLlCDEJfVG6B-MVuD9O/view?usp=drive_link',
      },
      {
        title: 'Chapter 4. 스네이크 게임(Snake Game)',
        items: ['스네이크 게임 규칙', '스네이크 게임 만들기', '스네이크 게임 실행'],
        downloadUrl: 'https://drive.google.com/file/d/1CFNxyvTxkCXT9Kbo_vVdm_acbPmCPnLC/view?usp=drive_link',
      },
      {
        title: 'Chapter 5. 핑퐁 게임(Ping Pong Game)',
        items: ['핑퐁 게임 규칙', '핑퐁 게임 리소스', '핑퐁 게임 만들기'],
        downloadUrl: 'https://drive.google.com/file/d/1EpfB9BUjkAamhCQOcsQEZUw3tDeD3Zvb/view?usp=drive_link',
      },
      {
        title: 'Chapter 6. 물고기 게임(Fish Game)',
        items: ['물고기 게임 규칙', '물고기 게임 리소스', '물고기 게임 만들기', '물고기 게임 실행', '물고기 게임 실행 파일 만들기'],
        downloadUrl: 'https://drive.google.com/file/d/1VEr0jGBLhXvt91gFt0z27zU7WwobbTdR/view?usp=drive_link',
      },
      {
        title: 'Chapter 7. 자동차 게임(Racing Car Game)',
        items: ['자동차 게임 규칙', '자동차 게임 리소스', '자동차 게임 만들기', '자동차 게임 실행', '자동차 게임 실행 파일 만들기'],
        downloadUrl: 'https://drive.google.com/file/d/1QHgdeost0PDCAKKYce1bUy8JxV1G2x3s/view?usp=drive_link',
      },
      {
        title: 'Chapter 8. 우주선 게임(Spaceship Game)',
        items: ['우주선 게임 규칙', '우주선 게임 리소스', '우주선 게임 만들기', '우주선 게임 실행', '우주선 게임 실행 파일 만들기'],
        downloadUrl: 'https://drive.google.com/file/d/1Q0PiBjK_BGZpm3BgDZpmbdBpWNtlwhpz/view?usp=drive_link',
      },
      {
        title: 'Chapter 9. 슈팅 게임(Shooting Game)',
        items: ['슈팅 게임 규칙', '슈팅 게임 리소스', '슈팅 게임 만들기', '슈팅 게임 실행', '슈팅 게임 실행 파일 만들기'],
        downloadUrl: 'https://drive.google.com/file/d/1ERHnquumfwJDV7yiih5n1X9g62cbpd-f/view?usp=drive_link',
      },
    ],
  },
  {
